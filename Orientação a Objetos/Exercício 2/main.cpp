...
int main()
{
    ...
    cout << "Resistor R1 (sem unidade): " << r1.get_R_sem_unidade() << " " << r1.get_unidade_fisica() << endl;
    cout << "Resistor R1 (com unidade): " << r1.get_R_com_unidade() << " " << r1.get_unidade_fisica() << endl;
    cout << "Resistor R2 (unidade): " << r2.get_unidade() << endl;
    cout << "Resistor R2 (sem unidade): " << r2.get_R_sem_unidade() << " " << r2.get_unidade_fisica() << endl;
    cout << "Resistor R2 (com unidade): " << r2.get_R_com_unidade() << " " << r2.get_unidade_fisica() << endl;
    cout << "Resistor R3 (unidade): " << r3.get_unidade() << endl;
    cout << "Resistor R3 (sem unidade): " << r3.get_R_sem_unidade() << " " << r3.get_unidade_fisica() << endl;
    cout << "Resistor R3 (com unidade): " << r3.get_R_com_unidade() << " " << r3.get_unidade_fisica() << endl;
